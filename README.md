...
<img src="gif0.gif" alt=""/>
The successful deployment of our model on an MAV, achieving the first vision-based autonomous aerial docking with an aircraft carrier, validates its real-world practicality.
